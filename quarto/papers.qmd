...
*"Cross-capability performance is limited by the weakest underlying capability."*
In *arXiv*, 2024<br>
...
<a href="#">A Systematic Examination of Preference Learning through the Lens of Instruction-Following</a><br>
*"Understand preference learning with rejection sampling and Monte Carlo Tree Search."*
In *arXiv*, 2024<br>
...
*"Predicting both critiques and the scalar reward improves reward modeling."*
In *arXiv*, 2024<br>
