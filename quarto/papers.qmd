...
*"Can ChatGPT solve, for example, sequence tagging?"*
In *arXiv*, 2023<br>
...
* J. Chen, **A. Zhang**, M. Li, A. J. Smola, and D. Yang<br>
...
*"Train diffusion language models faster with masks."*
In *arXiv*, 2023<br>
...
<a href="https://arxiv.org/abs/2305.04241" target="_blank">Vcc: Scaling Transformers to 128K Tokens or More by Prioritizing Important Tokens</a><br>
*"Only a small subset of tokens are important to the output."*
In *arXiv*, 2023<br>
